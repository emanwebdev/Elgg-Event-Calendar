...
$french = array (
  ...
  'event_calendar:event_tags_label' => 'Mots-clés',
  'event_calendar:event_tags_description' => 'Optionnel. Une liste de mots-clés séparés par des virgules.',
  'event_calendar:error_nosuchevent' => 'Erreur: Cet événement n\'existe pas.',
  'event_calendar:settings:times:title' => 'Ajouter du temps et la date aux événements',
  'event_calendar:settings:autogroup:title' => 'Ajouter automatiquement les événements du groupe à tous les membres dans leurs agendas personnels.',
  'event_calendar:settings:agenda_view:title' => 'Utilisez la vue Agenda',
  'event_calendar:settings:venue_view:title' => 'Afficher le lieu en vue sommaire (liste des événements)',
  ...
  'event_calendar:settings:region_list:title' => 'Liste des rListe des régions (une par ligne)
 (une seule par ligne)',
  ...
  'event_calendar:brief_description_label' => 'Description courte',
  ...
  'event_calendar:fees_description' => 'Optionnel. Coût de l\'événement.',
  'event_calendar:contact_label' => 'Contact',
  'event_calendar:contact_description' => 'Optionnel. La personne à contacter pour avoir plus de renseignements, préférablement avec un numéro de téléphone ou une adresse email.',
  ...
  'event_calendar:delete_confirm_description' => 'Etes-vous sûr de vouloir supprimer l\'événement "%s" ? Cette action est irréversible.',
  ...
  'event_calendar:settings:site_calendar:title' => 'Site de l\'agenda',
  ...
  'event_calendar:settings:group_default:no' => 'non (mais les administrateurs du groupe peuvent ajouter la fonction Agenda si désiré)',
